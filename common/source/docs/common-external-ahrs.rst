...
- `Anello X3 IMU <https://www.anellophotonics.com/products/x3>`__
...
Anello X3
~~~~~~~~~
Refer to :ref:`common-external-ahrs-anellox3` for setup.
...
-----------
    ...
    - :ref:`EAHRS_TYPE<EAHRS_TYPE>` = 1 (VectorNAV), 2 (MicroStrain5), 5(InertialLabs), 7(MicroStrain7), 11(AnelloX3)
